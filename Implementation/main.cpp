...
void GenerateRandomNumbers(uint32_t*& numbers, uint32_t*& search_numbers, const uint32_t number_elements)
{
...
auto RunBenchmarkIteration()
{
    ...
    GenerateRandomNumbers(numbers, search_numbers, number_elements);
